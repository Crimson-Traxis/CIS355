            ...
            echo "
                <div class='container'>
                    <div class='span10 offset1'>
                        ...
                        <div class='row'>
                            <a class='btn btn-primary' style='width:125px;' onclick='coursesRequest(\"displayCreate\")'>Add Course</a>
                            <table class='table table-striped table-bordered' style='background-color: lightgrey !important'>
                                ...
                                <tbody>";                                    
           foreach (Database::prepare('SELECT * , par01+par02+par03+par04+par05+par06+par07+par08+par09+par10+par11+par12+par13+par14+par15+par16+par17+par18 AS TotalSum FROM `tt_courses`', array()) as $row) {
                echo "
                    <tr>
                        <td>{$row['name'] } </td>
                        <td>{$row['email'] }</td>
